...
The final website shuld present the civil engineering service, be multiliggual (ita (default) and eng), have a contact info box, be responsive (probably is already), cookie management, have a cms like sanity to let him be able to edit the content of the website (text, img, documents)

## References

I qill attach the actual screenshot of different pages; the pages of a reference website, and the content (text, pictures, video, documents) thatI have, because I would'nt even know how to design/structure these elements in the website.
...
My main issue is not to be expert with nextjs best practices and really bad at html and css, also having no fantasy about design and where is better to put things. By the way I am a developer so something, once understood how it works, I can do it so for instance once understood how to setup sanity, or translations I can do it.
